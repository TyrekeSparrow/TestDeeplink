...
//        final String hostUrl = UrlHelper.replaceHost(urlStr);
        final String hostUrl = urlStr;
        try {
...
//            Log.i(Tags.HTTP_REQUEST, "responseCode = " + responseCode);
            if (responseCode == 200) {
                // get response result
    ...
    private static byte[] encodeParams(Map<String, String> params) throws UnsupportedEncodingException {
        ...
        // Log.i(Tags.HTTP_REQUEST, "encodedParams = " + encodedParams);
...
//        connection.setRequestProperty(HEAD_REGION_KEY, "region");
//        connection.setRequestProperty(HEAD_LANGUAGE_KEY, "local");
